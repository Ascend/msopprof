...
- msopprof具体特性支持情况请参见[**表 2**  msopprof热点图的功能介绍](#msopprof热点图的功能介绍)。
    ...
    **表 2**  msopprof热点图的功能介绍<a id="msopprof热点图的功能介绍"></a>
    ...
    <th class="cellrowborder" valign="top" width="20.027997200279973%" id="mcps1.2.7.1.5"><p id="zh-cn_topic_0000001979517132_p434612561391"><span id="zh-cn_topic_0000001979517132_ph2272194216543">昇腾910_95 AI处理器</span></p>
    </th>
